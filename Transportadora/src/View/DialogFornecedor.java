...
public class DialogFornecedor extends javax.swing.JDialog {
    ...
    private void carregaTable(){
        ...
        new MyTableModel (Fornecedor.class,
   ...
   private Fornecedor populateObject() throws NumberFormatException{
   ...
   private void populateComponentes(Fornecedor fornecedor){
        texto_id.setText(fornecedor.getId()+"");
        texto_nome.setText(fornecedor.getNome());
        texto_nomecontato.setText(fornecedor.getNome_contato());
        texto_endereco.setText(fornecedor.getEndereco());
        texto_telefone.setText(fornecedor.getTelefone());
        texto_cep.setText(fornecedor.getCep());
        texto_razao_social.setText(fornecedor.getRazao_social());
        texto_cnpj.setText(fornecedor.getCnpj());
        combo_cidade.setSelectedItem(fornecedor.getCidade()); 
        combo_estado.setSelectedItem(fornecedor.getEstado()); 
        combo_pais.setSelectedItem(fornecedor.getPais()); 
    }
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addComponent(texto_telefone, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void TableFornecedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableFornecedorMouseClicked
        ...
        if (evt.getClickCount()==2){
            ...
            this.populateComponentes(
                dao.get(Fornecedor.class, codigo));
        }
